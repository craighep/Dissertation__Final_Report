...
The results showed that the length between each vector seemed to exponentially increase on each additional loop. And becuase the distance of the Z axis was currently being hard written into each maneouvre, the only reasoning for this part of the issue was that 
